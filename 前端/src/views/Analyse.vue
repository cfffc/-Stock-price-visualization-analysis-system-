  ...
  <div  style="display: flex; flex-direction: column; height: 100%; width: 100%">
    <div style="height: fit-content">
      ...
      <el-row style="margin-top: 1rem">
        <el-select v-model="data.dayCounts" filterable placeholder="统计天数" style="width: 10rem">
        ...
        <el-select v-model="data.preDay" filterable placeholder="对比天数" style="margin-left: 1rem; width: 10rem">
          <el-option label="3" value="3"/>
          <el-option label="5" value="5"/>
          <el-option label="7" value="7"/>
        </el-select>
        <el-button style="margin-left: 1rem" type="danger" @click="energyStatePredict(4)">均线能量分析</el-button>
      </el-row>
    </div>

    <div style="flex: 1; padding: 1rem 0;">
      <div v-if="data.showMode === 1" id="chart" class="single-chart"></div>
      <div v-if="data.showMode === 4" id="chart" class="single-chart"></div>

      <el-table v-if="data.showMode === 2" id="img-container" :cell-style="{'text-align':'center'}"
                :data="data.stockDataList" :header-cell-style="{'text-align':'center'}"
                border style="width: 100%; margin-top: 1rem;">
      ...
      <el-table v-if="data.showMode === 3" id="img-container" :cell-style="{'text-align':'center'}"
                :data="data.averageDataList" :header-cell-style="{'text-align':'center'}"
                border style="width: 100%; margin-top: 1rem;">
        <el-table-column label="日期" prop="stockDate"/>
