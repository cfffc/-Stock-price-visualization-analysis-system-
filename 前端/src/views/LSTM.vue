  ...
  <div  style="display: flex; flex-direction: column; height: 100%; width: 100%">
    <div style="height: fit-content">
      ...
      <el-row style="margin-top: 1rem">
        <el-input v-model="data.loss" placeholder="均方误差" readonly style="margin-right: 1rem; width: 8rem;"/>
        <el-input v-model="data.mape" placeholder="平均绝对百分比误差" readonly style="margin-right: 1rem; width: 10rem;"/>
    ...
    function predict(type) {
      ...
      postRequest("/stockData/lstm", {
        ...
        if (res.data.code === 200) {
          ...
          data.loss = "均方误差：" + res.data.data[1];
          data.mape = "平均绝对百分比误差：" + res.data.data[2];
